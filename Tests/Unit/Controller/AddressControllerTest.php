...
/**
 * Test case for class VMeC\VmecChurches\Controller\AddressController.
 *
...
class AddressControllerTest extends \TYPO3\CMS\Core\Tests\UnitTestCase {
	...
	/**
	 * @var \VMeC\VmecChurches\Controller\AddressController
	 */
	protected $subject = NULL;

	protected function setUp() {
		$this->subject = $this->getMock('VMeC\\VmecChurches\\Controller\\AddressController', array('redirect', 'forward', 'addFlashMessage'), array(), '', FALSE);
	}
	...
	public function listActionFetchesAllAddressesFromRepositoryAndAssignsThemToView() {
		...
		$addressRepository = $this->getMock('VMeC\\VmecChurches\\Domain\\Repository\\AddressRepository', array('findAll'), array(), '', FALSE);
	...
	public function showActionAssignsTheGivenAddressToView() {
		$address = new \VMeC\VmecChurches\Domain\Model\Address();
